...
<section class="content">
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="box box-info">
				<div class="box-header with-border">
					<h3 class="box-title">Latest Insurance</h3>
				...
				<div class="box-body">
					<div class="table-responsive">
						<table class="table no-margin" style="font-size: 13px;">
							...
							<tbody>
								<?php foreach ($latest_insurances as $index => $policy) : ?>
									<tr>
										<td><?= $policy['number']; ?></td>
				...
				<!-- /.box-body -->
				<div class="box-footer clearfix">
					<a href="<?= base_url('admin/insurances'); ?>" class="btn btn-sm btn-default btn-flat pull-right">View All Insurances</a>
				</div>
				<!-- /.box-footer -->
			</div>
			<!-- /.box -->
