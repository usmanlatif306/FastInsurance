          ...
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/languages/add'), 'class="form-horizontal"');  ?>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="display_name" class="form-control" id="group_name" placeholder="e.g., English">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="directory_name" class="form-control" id="group_name" placeholder="e.g., english">
                </div>
              </div>
